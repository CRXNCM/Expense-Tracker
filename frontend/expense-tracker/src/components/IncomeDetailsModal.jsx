...
import { X, DollarSign, Calendar, Tag, Edit, Trash2, ChevronDown, ChevronUp } from 'lucide-react';
...
const IncomeDetailsModal = ({ isOpen, onClose, income, onEdit, onDelete }) => {
    ...
    <div className="fixed inset-0 bg-gray-900/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
        ...
        <div className="bg-gradient-to-r from-blue-400 to-blue-600 rounded-t-2xl p-6 text-white">
          ...
          <p className="text-blue-100 mt-1">View your income information</p>
        </div>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-blue-100 rounded-full">
              <span className="text-4xl">{income.icon}</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-lg font-semibold text-gray-800">{formatDate(income.date)}</p>
            </div>
            ...
            {income.category && (
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-lg font-semibold text-gray-800">{income.category}</p>
              </div>
            )}
          ...
          <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-4 border">
            <div className="text-center">
              <p className="text-sm text-gray-600 mb-1">Income Summary</p>
              <p className="text-xl font-bold text-gray-800">{income.source}</p>
              <p className="text-2xl font-bold text-green-600 mt-1">{formatCurrency(income.amount)}</p>
              <p className="text-sm text-gray-500 mt-2">{formatDate(income.date)}</p>
            </div>
          </div>
